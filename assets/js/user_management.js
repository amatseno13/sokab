/* SOKAB — kelola pengguna (khusus admin).
   Dulu di-include sebagai PHP di tengah blok <script>; kini file JS biasa
   dan hanya dimuat kalau pengguna admin. */
...
// ═════════════════════════════════════════════════════════════════════
        ...
        function renderUserTable(users) {
            ...
            tbody.innerHTML = users.map((u, i) => {
                ...
                const currentUserId = window.SOKAB.userId;
